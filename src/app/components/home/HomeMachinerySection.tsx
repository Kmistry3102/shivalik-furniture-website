      ...
      <section className="bg-black py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center lg:mb-12 mb-8 lg:space-y-6 space-y-4">
            ...
            <p className="text-xl sm:text-2xl text-gray-100 font-light leading-relaxed ">
                ...
                {machinerySectionData.images.map((image, index) => (
                  <SwiperSlide key={image.id}>
                    <div className="relative bg-white rounded-lg overflow-hidden">
                      <div className="lg:aspect-[16/8] aspect-[10/14] relative max-w-full max-h-full">
                        <Image
                          src={image.src}
                          alt={image.alt}
                          fill
                        ...
                        {/* Text Overlay */}
                        <div className="absolute bottom-0 left-0 right-0 p-6 text-white max-w-2xl space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
            {machinerySectionData.features.map((feature) => (
              <button
                ...
                className={`
                bg-black cursor-pointer text-white border border-white/20 px-4 py-3 rounded font-light lg:text-base text-sm transition-all duration-300
                ${
